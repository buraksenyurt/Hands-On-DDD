    ...
    public async Task Handle(object command)
    {
        ...
        using (_unitOfWork)
        {
            try
            {
                ...
                switch (command)
                {
                    case Contracts.V1.Create createCmd:
